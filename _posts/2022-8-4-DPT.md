...
<!-- Converted from GIF to WebM with: ffmpeg -i fast_dpt.gif -c:v libvpx-vp9 -b:v 0 -crf 35 -an -loop 0 fast_dpt.webm -->
<video src="./../webm/fast_dpt.webm" style="width:100%;border-radius:0.25rem;" autoplay loop muted playsinline></video>
...
<!-- Converted from GIF to WebM with: ffmpeg -i dpt.gif -c:v libvpx-vp9 -b:v 0 -crf 35 -an -loop 0 dpt.webm -->
<video src="./../webm/dpt.webm" style="width:100%;border-radius:0.25rem;" autoplay loop muted playsinline></video>
